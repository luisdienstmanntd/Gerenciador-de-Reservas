...
| `js/ui/controls.js` | **v9.1** | 2026-07-16 — editor de "Bloqueios Antecipados" com trava por switch (item #69, ajuste #70). 2026-07-10 — switch de travar/destravar em Configurações, switch de bloqueio automático, `salvarConfiguracoes()` grava em `config_sistema` (Supabase) em vez de `localStorage` (bugs #52, #56) |

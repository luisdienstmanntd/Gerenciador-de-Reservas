...
| `js/features/reservas/modal.js` | **v3.14** | 2026-07-13 — menus de resumo e o seletor de ação (`abrirNova`) redesenhados com ícones SVG lineares + classes `.resumo-btn` (bugs #60, #61) |
